...
internal class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        XElement? myOrders = XDocument.Load("C:\\Users\\Chani\\Desktop\\לימודים\\c#\\אחרון חביב\\dotNet5783_5296_3351\\targil1\\Order.xml").Root;
        ...
        for (int i = 0; i < ord.Length; i++)
        {
          ...
          // orders.Add(dr);
                ...
                myOrders?.Save("C:\\Users\\Chani\\Desktop\\לימודים\\c#\\אחרון חביב\\dotNet5783_5296_3351\\targil1\\Order.xml");
